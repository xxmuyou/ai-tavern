...
- **积分来源**：注册赠送（一次性）、月度赠送（随订阅 tier）、pay-as-you-go 充值。
...
- 新用户注册一次性赠送 **2000 credits**（≈40 张图），不过期。
...
- Free 升 Pro 后本月可再获 Pro grant；Pro 取消后到期前仍按 Pro 判定。
...
- $9.99 是英文消费市场心理舒适价位，且 Pro 月度 30000 积分（≈600 张图）对重度用户极具吸引力。
...
- **注册需邮箱验证**（防机器人）。
- **多账号**：v1 不做强反多账号；注册赠送 2000 是一次性、与设备/邮箱绑定的主要薅羊毛面，监测同 IP 大量新账号 → 软封禁。相比旧的"每日 30 条免费"，一次性赠送更难规模化薅。
...
- [ ] 订阅价格：$9.99/月？
- [x] 兑换率：$1 = 1000 积分
- [x] 注册赠送：2000；月度 Free 1000 / Pro 30000
- [x] 生图 50/张、聊天 1/条
