  ...
  return (
    ...
    >
      <View className="mb-10 grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <WebStat eyebrow="Companions" value={String(totalCompanions)} description="Across the city" icon={<Ionicons color="#D97757" name="people-outline" size={16} />} />
      </View>
        ...
        <View className="absolute left-5 right-5 bottom-4 flex-row items-end justify-between gap-3">
          ...
          {scene.unlocked ? (
            ...
            <View className="flex-row items-center gap-1.5 rounded-full bg-app-twilight/85 px-3 py-1 backdrop-blur">
              <Ionicons color="#FCE3D6" name="lock-closed" size={12} />
