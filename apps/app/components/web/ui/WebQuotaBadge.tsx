  ...
  if (isLoading && !credits) {
    return (
      <Container
        ...
        onPress={onPress}
        className={cn('h-9 flex-row items-center gap-2 rounded-full border border-app-line bg-app-sunken/50 px-3.5', onPress && 'hover:bg-app-sunken', className)}
      >
